...
public class OptionalEg {
	/*
	 * public static String getName(){ return null; //Bad practice }
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * Dont use the get() as the following. It will throw NoSuchElementException
		 * than NullPointerException Exception in thread "main"
